...
(function(w, d) {
	...
	w[spy_config.jsonCallback] = function(json) {
		...
		if (spy_config.animatedRecentPost) {
			$('#' + spy_config.containerId + ' ul').nuanyar({
				visible: spy_config.nuanyar.visible,
				interval: spy_config.nuanyar.interval,
				speed: spy_config.nuanyar.speed
			});
		}
